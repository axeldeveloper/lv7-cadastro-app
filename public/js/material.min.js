...
!(function () {
    ...
    (s = (function () {
        ...
        function n(i, n) {
            ...
            for (var r, d = 0, _ = l.length; _ > d; d++) {
                ...
                E.initEvent("mdl-componentupgraded", !0, !0),
                    i.dispatchEvent(E);
            }
        }
        function a(e) {
    ...
    (window.MaterialRadio = p),
        ...
        (p.prototype.mdlDowngrade_ = function () {
            ...
            this.btnElement_.removeEventListener(
                "change",
                this.boundChangeHandler_
            ),
                this.btnElement_.removeEventListener(
    ...
    (window.MaterialTextfield = E),
        ...
        (E.prototype.mdlDowngrade_ = function () {
            this.input_.removeEventListener(
                "input",
                this.boundUpdateClassesHandler
            ),
                this.input_.removeEventListener(
        ...
        (I.prototype.init = function () {
            if (this.element_) {
                ...
                if (
                    ...
                    for (
                        var m = this.tabBar_.querySelectorAll(
                                "." + this.CssClasses_.TAB
                            ),
                            E = this.content_.querySelectorAll(
